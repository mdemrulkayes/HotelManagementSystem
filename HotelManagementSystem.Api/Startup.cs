...
namespace HotelManagementSystem.Api
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IServiceProvider serviceProvider)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "SSPM");

            });

            #region Redirect Swagger on start up
            ...
            SeedRole(serviceProvider).Wait();
        }

        private async Task SeedRole(IServiceProvider serviceProvider)
        {
            var roleManager = serviceProvider.GetRequiredService<RoleManager<IdentityRole>>();
            string[] roleNames = { "Developer", "Admin", "User" };
